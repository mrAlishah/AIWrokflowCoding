...
PR Review guides explain how to run the daily end-to-end local PR/code review workflow from local git diff.

## Who Should Use It

Use this area when asking an AI agent to perform PR Review work in the V2 AI Operating System.
...
Any agent that can inspect local git diff and follows review guardrails.
...
4. Copy the matching prompt from `docs/ai/reference/prompts/pr/`.
