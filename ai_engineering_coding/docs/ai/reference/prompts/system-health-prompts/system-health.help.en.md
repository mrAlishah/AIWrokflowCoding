...
Run the full V2 AI Operating System health check prompt.

# Parameters

| Parameter | Required | Description |
|---|---|---|
| CHECK_SCOPE | Optional | Audit scope. Example: full. |
| CHECK_COMPATIBILITY | Optional | Whether to check backward compatibility. Example: true. |
| REPORT_MODE | Optional | Report output mode. Example: latest-and-history. |
| ANALYSIS_DEPTH | Optional | Analysis depth. Example: deep. |
...
| foundation-only | Check historical foundation material only. |
...
| latest-and-history | Write latest.md and dated history copy. |
