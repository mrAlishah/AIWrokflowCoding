...
- Follow runtime read order strictly.
- Read active review workspace only.
- Read repo-context only if required.
- Read exact changed files only if required.
- Do not read docs/ai/reference/\*\*.
